...
public class Prisma_Alloy_Pickaxe extends PickaxeItem {
    public Prisma_Alloy_Pickaxe(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
