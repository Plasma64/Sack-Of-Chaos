...
public class Prisma_Alloy_Shovel extends ShovelItem {
    public Prisma_Alloy_Shovel(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
